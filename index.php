...
<html>
	...
	<?php 
		$connect = mysqli_connect('3.128.54.48','batpromax_user','123@123a','batpromax_db');
		if(!$connect)
		{
	...
	<aside id="fh5co-hero" class="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(images/12ww.jpg);">
		   	...
		   	<li style="background-image: url(images/7227619.webp);">
		   		<div class="container">
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<!-- <div class="desc">
		   	...
		   	<li style="background-image: url(images/thumb-1920-476260.jpg);">
		   		<div class="container">
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<!-- <div class="desc">
		   	...
		   	<li style="background-image: url(images/5c1cb57906af3-wallpaper-preview.jpg);">
		   		<div class="container">
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<!-- <div class="desc">
	...
	<div id="fh5co-product">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(images/o-to-do-choi-1.jpg);">
						...
						<div class="desc">
							<h3><a href="single.html">Control car</a></h3>
				...
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(images/ddddd.jpg);">
							<span class="sale">Sale</span>
							<div class="inner">
								<p>
									<a href="single.html" class="icon"><i class="icon-shopping-cart"></i></a>
			...
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(images/pngtree-yellow-toy-car-vehicle-png-image_3922772.jpg);">
							<div class="inner">
								<p>
									<a href="single.html" class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="single.html" class="icon"><i class="icon-eye"></i></a>
						...
						<div class="desc">
							<h3><a href="single.html">Stylish model toy car</a></h3>
				...
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(images/sssssw2.png);">
							<div class="inner">
								<p>
									<a href="single.html" class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="single.html" class="icon"><i class="icon-eye"></i></a>
						...
						<div class="desc">
							<h3><a href="single.html">Cargo model toy car</a></h3>
				...
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(images/images.jpg);">
							<div class="inner">
								<p>
									<a href="single.html" class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="single.html" class="icon"><i class="icon-eye"></i></a>
						...
						<div class="desc">
							<h3><a href="single.html">Crane model toy car</a></h3>
							<span class="price">$60</span>
						</div>
					</div>
				</div>
